# Pi local extensions and notes

This repository contains the local pi customizations and supporting notes used on this machine.
...
The installer copies the extension directories and reapplies the versioned `/skills` runtime patch. It does not modify
pi settings. Use `--skip-skill-loading-patch` to install only the extensions.
...
Run only the extension helper tests with:
