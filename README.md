...
[`patches/pi-0.87.1/README.md`](patches/pi-0.87.1/README.md#tests)). Install [ShellCheck](https://www.shellcheck.net/)
and the pinned npm dependencies, which also installs the repository's Git hooks:
