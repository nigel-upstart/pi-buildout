...
function classifierSystemPrompt(stage: "primary" | "secondary"): string {
  return [
    ...
    "Use a multi-PR horizon only when the user explicitly requests PR decomposition or work spanning that many PRs; multiple files, fixes, commits, or evaluation steps can still be one single_pr task.",
