...
function classifierSystemPrompt(stage: "primary" | "secondary"): string {
  return [
    ...
    "action_mode is what the requested work does, ordered from least to most consequential: information_only, local_read, reversible_mutation, external_side_effect, destructive.",
